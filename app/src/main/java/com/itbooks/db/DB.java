...
public final class DB {
	 ...
	 * @param download {@link Download} A download instance.
	 ...
	 * @param downloadId The id provided by Android when started downloading.
	 * @return {@link Download}.
	 */
	public @Nullable Download getDownload(long downloadId) {
		if (mDB == null || !mDB.isOpen()) {
			open();
		}
		Cursor c;
		...
		try {
			...
			while (c.moveToNext()) {
				book = new RSBook(
						c.getString(c.getColumnIndex(DownloadsTbl.BOOK_NAME)),
